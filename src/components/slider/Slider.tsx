...
const slides = [
  {
    id: 1,
    title: "Colecciones de Venta de Verano",
    description: "¡Venta! ¡Hasta un 50% de descuento!",
  ...
  {
    id: 2,
    title: "Colecciones de Venta de Invierno",
    description: "¡Venta! ¡Hasta un 50% de descuento!",
  ...
  {
    id: 3,
    title: "Colecciones de Venta de Primavera",
    description: "¡Venta! ¡Hasta un 50% de descuento!",
...
const Slider = () => {
  ...
  useEffect(()=>{
    const interval = setInterval(() => {
      setCurrent(prev => (slides.length - 1) === prev ? 0 : prev + 1)
    },3000)
        ...
        {slides.map((slide, index) => (
          ...
          >
            ...
            >
              ...
              <h1 className="text-5xl lx:text-6xl 2xl:text-8xl font-semibold">
                {slide.title}
              </h1>
              <Link
                href={slide.url}
